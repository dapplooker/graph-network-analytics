...
import { getNetworkConfigurations as NetworkConfigs } from "../../configurations/configurations/configurations";
...
export function getOrCreateToken(tokenAddress: Address, event: ethereum.Event): Token {
...
export function getOrCreateProtocol(): Protocol {
    let protocol = Protocol.load(Address.fromString("0x369e6f597e22eab55ffb173c6d9cd234bd699111"));

    if (!protocol) {
        protocol = new Protocol(Address.fromString("0x369e6f597e22eab55ffb173c6d9cd234bd699111"));
    ...
    protocol.schemaVersion = "VersionConstant";
    protocol.subgraphVersion = "VersionConstant";
    protocol.methodologyVersion = "VersionConstant";
...
export function getOrCreateUsageMetricsDailySnapshot(
    ...
    if (!snapshot) {
        ...
        snapshot.day = day;
        snapshot.protocol = Address.fromString("0x369e6f597e22eab55ffb173c6d9cd234bd699111");
